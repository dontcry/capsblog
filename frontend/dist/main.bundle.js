...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "619f00b8711c29b17b62";
...
*/
var aa=__webpack_require__("./node_modules/react/index.js"),n=__webpack_require__("./node_modules/object-assign/index.js"),q=__webpack_require__("./node_modules/scheduler/index.js");function u(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(u(227));var ba=null,ca={};
...
var baseUrl = 'http://127.0.0.1:5000/api'; // blog api

var api_getBlogs = function getBlogs() {
  var url = "".concat(baseUrl, "/blogs");
...
function (_React$Component) {
  ...
  _createClass(Hello, [{
    ...
    value: function render() {
      return react_default.a.createElement("p", null, "hello react111223334444\uFF01");
    }
  }]);
...
Object(react_dom["render"])([react_default.a.createElement(src_Hello, null)], document.getElementById('root'));
api_getBlogs().then(function (res) {
  console.log(res);
})["catch"](function (err) {
  console.log(err);
});
